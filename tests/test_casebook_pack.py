"""Regression checks for the signal-ops-cleanup-deck casebook."""
...
from casebook.harness import assert_expected, signal_ops_cleanup_deck_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(signal_ops_cleanup_deck_summary(), assert_expected())
